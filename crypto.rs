...
impl ZKProof {
    ...
    pub fn verify_share(proof: &Proof, verification_key: &PublicKey, context: &str) -> bool {
        schnorr_verify(proof, verification_key, context)
    }

    /// Batch verification of multiple proofs
    pub fn batch_verify(proofs: &[Proof], verification_keys: &[PublicKey], context: &str) -> bool {
...
impl KeyDerivation {
    ...
    pub fn derive_group_public_key(mpk: &MasterPublicKey, group_id: &str) -> Result<PublicKey> {
