use crate::{
    ...
    types::*,
    utils::{
        hash_h1, hash_h2, hash_h2_bytes, hash_h3, pad_or_truncate, scalar_add, scalar_mul,
        xor_bytes,
    },
};
use rand::rngs::OsRng;
...
impl DIBTDEncryption {
    ...
    pub fn encrypt(message: &[u8], group_id: &str, mpk: &MasterPublicKey) -> Result<Ciphertext> {
